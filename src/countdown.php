...
class CountdownTimer
{
  ...
  private function applyTextToImage($image, $font, $date)
  {
    ...
    $labels = array('DIAS', 'HORAS', 'MINUTOS', 'SEGUNDOS');
    //imagettftext($image, 15, 0, $this->xOffset + ($this->characterWidth * $this->labelOffsets[$key]), 99, $font['color'], $font['path'],
...
new CountdownTimer(array(
  'time' => isset($_GET['width']) ? $_GET['time'] : "2020-25-15",
